      ...
      >
        ...
        {onAddToCart && (
          <button
            ...
            className="absolute bottom-4 right-4 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-sm transition-all duration-300 hover:scale-105 hover:bg-secondary hover:text-secondary-foreground focus:outline-none"
